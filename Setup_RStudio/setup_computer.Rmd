...
These directions assume that you don't have a computer and will be using the remote desktop (https://rdweb.wvd.microsoft.com/webclient/index.html).  If you go to that link and log in with your PSU username, the @pdx.edu name, and your PSU credentials, you will have access to a full windows machine through a browser.
...
Then update the regular packages with:
...
To update the course library type:
