...
We will add some extra arguments to the chunks to display things, like tables and figures, the way we like, but that will be later.  In the mean time, enjoy this picture of some dogs as an example of how to add a picture.
